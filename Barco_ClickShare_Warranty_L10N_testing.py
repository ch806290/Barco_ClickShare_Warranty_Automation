...
class Test(unittest.TestCase):
    ...
    def test_L001_FAST_Mandarin_Barco_clickshare_warrenty_input_valid(self):
        """
        [FAST]前往Barco,切換成中文,並輸入合法 value "1863552437",並檢查結果
        """
    ...
    def test_L002_FAST_Mandarin_Barco_clickshare_warrenty_input_invalid(self):
        """
        [FAST]前往Barco,切換成中文,並輸入不合法 value "123456",並檢查結果
        """
    ...
    def test_L003_FAST_Japanese_Barco_clickshare_warrenty_input_valid(self):
        """
        [FAST]前往Barco,切換成日文,並輸入合法 value "1863552437",並檢查結果
        """
        ...
        lang_dropDown = Select(self.driver.find_element_by_css_selector(LANG_SELECT_BUTTON))
        lang_dropDown.select_by_visible_text('日本語')
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Japanese+" "+input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_Description.text,Description,"Supposed to be as same as Description")
        self.assertEqual(result_PartNumber.text,Part_number,"Supposed to be as same as Part_number")
        self.assertEqual(result_DeliveryDate.text,Delivery_date,"Supposed to be as same as Delivery_date")
    ...
    def test_L004_FAST_Japanese_Barco_clickshare_warrenty_input_invalid(self):
        """
        [FAST]前往Barco,切換成日文,並輸入不合法 value "123456",並檢查結果
        """
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Japanese+" "+input_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_value,"Supposed to be as same as input value")
        self.assertEqual(result_Message.text,Result_message_Japanese,"Supposed to be as same as result message")

    def test_L005_FAST_Spanish_Barco_clickshare_warrenty_input_valid(self):
        """
        [FAST]前往Barco,切換成西班牙文,並輸入合法 value "1863552437",並檢查結果
        """
        ...
        lang_dropDown = Select(self.driver.find_element_by_css_selector(LANG_SELECT_BUTTON))
        lang_dropDown.select_by_visible_text('español')
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Spanish+" "+input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_Description.text,Description,"Supposed to be as same as Description")
        self.assertEqual(result_PartNumber.text,Part_number,"Supposed to be as same as Part_number")
        self.assertEqual(result_DeliveryDate.text,Delivery_date,"Supposed to be as same as Delivery_date")
    ...
    def test_L006_FAST_Spanish_Barco_clickshare_warrenty_input_invalid(self):
        """
        [FAST]前往Barco,切換成西班牙文,並輸入不合法 value "123456",並檢查結果
        """
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Spanish+" "+input_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_value,"Supposed to be as same as input value")
        self.assertEqual(result_Message.text,Result_message_Spanish,"Supposed to be as same as result message")

    def test_L007_FAST_Korea_Barco_clickshare_warrenty_input_valid(self):
        """
        [FAST]前往Barco,切換成韓文,並輸入合法 value "1863552437",並檢查結果
        """
        ...
        lang_dropDown = Select(self.driver.find_element_by_css_selector(LANG_SELECT_BUTTON))
        lang_dropDown.select_by_visible_text('한국어')
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Korea+" "+input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_valid_value,"Supposed to be as same as input value")
        self.assertEqual(result_Description.text,Description,"Supposed to be as same as Description")
        self.assertEqual(result_PartNumber.text,Part_number,"Supposed to be as same as Part_number")
        self.assertEqual(result_DeliveryDate.text,Delivery_date,"Supposed to be as same as Delivery_date")
    ...
    def test_L008_FAST_Korea_Barco_clickshare_warrenty_input_invalid(self):
        """
        [FAST]前往Barco,切換成韓文,並輸入不合法 value "123456",並檢查結果
        """
        ...
        self.assertEqual(result_title_L10N.text,Result_title_Korea+" "+input_value,"Supposed to be as same as input value")
        self.assertEqual(result_title.text,input_value,"Supposed to be as same as input value")
        self.assertEqual(result_Message.text,Result_message_Korea,"Supposed to be as same as result message")

basedir = "D:\Derrick_only\Practice\Homework\\auto_test"
if __name__ == '__main__':
    # 取得資料夾目錄底下，符合後面任何副檔名為.py，並進行所有test的測試項目
    test_suite = unittest.defaultTestLoader.discover(
        basedir, pattern='Barco_ClickShare_Warranty_L10N_testing.py')

    # 測試結果加入到 BeautifulReport 套件內
    result = BeautifulReport(test_suite)

    # 結果產生Report 檔案名稱為 filename, 敘述為 description, log_path 預設放在跟目錄底下就行
    result.report(filename='Barco_assignment_report_03',
